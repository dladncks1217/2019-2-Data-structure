...
//      t.insertLast(500);    t.print();
      ...
      ArrList<Double> d = new ArrList<Double>();
      d.insertLast(1.0); d.print();
      d.insertLast(2.0); d.print();
      d.insertLast(3.0); d.print();
      d.insertLast(4.0); d.print();
      d.insertLast(5.0); d.print();
      d.delete(0); d.print();
      d.delete(0); d.print();
      d.delete(0); d.print();
   }
