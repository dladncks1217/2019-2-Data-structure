public class Task_0910_1 {
	public static void main(String[] args) {
		ArrList<String> s = new ArrList<String>();
		s.insertLast("apple");	s.print(); s.delete(0);  s.print();	s.insertLast("orange"); s.print();
		s.insertLast("cherry");	s.print(); s.delete(0); s.print();	s.insertLast("pear");   s.print();
